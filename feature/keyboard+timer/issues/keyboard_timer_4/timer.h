...
// PAS SUR QUE CELLE CI SOIT UTILE : A VOIR
int etat_button_timer_pin = 0;               // variable d'Ã©tat du bouton START



  // VARIABLES RELATIVES AU TEMPS
long time_elapsed_since_launched_sec = 0;                     // Temps Ã©coulÃ© depuis que l'on a appuyÃ© sur START
long temps_max_bomb;  
...
class Timer
{
  ...
  void reset()
   ...
   void update_timer()
    ...
    long time_timer_launched_; //instant où l'on lance le timer
